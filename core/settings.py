...
INSTALLED_APPS = [
    ...
    "apps.payments",
    "apps.file_manager",
    "apps.failures", # my app for shelf life failures
    "apps.product_evaluation", # my app for product evaluation
...
ACCOUNT_LOGIN_TEMPLATE = "authentication/sign-in.html"

# Redirection settings
LOGIN_URL = '/'  # Direct to root which is now the sign-in page
LOGIN_REDIRECT_URL = "dashboard"  # No change needed here, assuming dashboard is the post-login destination
ACCOUNT_LOGOUT_REDIRECT_URL = '/'  # Direct to root for logout redirect
