document.addEventListener('DOMContentLoaded', function () {
    const endpoints = [
        ...
        '/failures/snapshot-shelflife-this-month-commodities/',
        '/failures/snapshot-shelflife-last-month-commodities/',
        '/failures/snapshot-shelflife-two-months-ago-commodities/'
    ];
    ...
    const elementIds = [
        ...
        'this-month-failure-snapshot-4',
        'this-month-failure-snapshot-5',
        'this-month-failure-snapshot-6'
    ];
